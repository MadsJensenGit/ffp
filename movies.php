...
<div class="container mt-5">
    <div class="row g-4">
        ...
        foreach ($movies as $movie):
            ...
            ?>
            <div class="col-md-4"> <!-- 3 barber per row on larger screens -->
                <a href="barber.php?barberId=<?php echo $barber->barberId; ?>" class="text-decoration-none">
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            <h5 class="card-title"><?php echo htmlspecialchars($barbernavn->BarberName); ?></h5>
                            <p class="card-text"><?php echo htmlspecialchars($barberbeskriv->BarberDescription); ?></p>
                        </div>
